...
- (void)outputDeviceChanged:(NSNotification *)notification {
    ...
    switch (routeChangeReason) {
        case AVAudioSessionRouteChangeReasonNewDeviceAvailable: {
            ...
            UIAlertController *controller = [UIAlertController alertControllerWithTitle:@"提示" message:@"耳机插入" preferredStyle:UIAlertControllerStyleAlert];
            [controller addAction:okAction];
            [[self presentingVC] presentViewController:controller animated:YES completion:nil];
        }
            break;
        case AVAudioSessionRouteChangeReasonOldDeviceUnavailable:
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                UIAlertAction *okAction = [UIAlertAction actionWithTitle:@"好的" style:UIAlertActionStyleDefault handler:nil];
                UIAlertController *controller = [UIAlertController alertControllerWithTitle:@"提示" message:@"耳机拔出" preferredStyle:UIAlertControllerStyleAlert];
                [controller addAction:okAction];
                [[self presentingVC] presentViewController:controller animated:YES completion:nil];
            });
            break;
