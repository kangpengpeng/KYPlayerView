...
+ (UIImage *)getBundleImage:(NSString *)imageName {
    ...
    NSString *imagePath = [currBundle pathForResource:imageName ofType:nil inDirectory:@"KYPlayerView.bundle"];
    //NSString *imagePath = [currBundle pathForResource:imageName ofType:nil];
